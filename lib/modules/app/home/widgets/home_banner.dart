...
class HomeBanner extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> banners = [
      {
        'image':
            'https://img.freepik.com/free-photo/summer-fashion-concept-with-accessories_23-2148160216.jpg',
        'title': 'Summer',
        'subtitle': 'SALE',
        'discount': '50% OFF',
      },
      {
        'image':
            'https://img.freepik.com/free-photo/elegant-woman-stylish-dress-posing-beach_23-2148154625.jpg',
        'title': 'New',
        'subtitle': 'ARRIVALS',
